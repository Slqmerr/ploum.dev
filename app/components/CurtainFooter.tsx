...
export default function CurtainFooter() {
  ...
  return (
    <div ref={scope} id="contact">
      <footer
        className="curtain-footer fixed inset-0 z-30 min-h-svh overflow-hidden border-t-2 border-black bg-background/40 backdrop-blur-xl will-change-transform motion-reduce:static motion-reduce:border-t-0"
        style={{ transform: "translateY(100%)" }}
      >
        <div className="curtain-inner flex h-full min-h-svh flex-col justify-between px-4 pt-5 pb-4 md:px-8 md:pt-6 md:pb-6">
          <div className="flex items-start justify-between border-b-2 border-black pb-4 text-[0.65rem] font-bold tracking-[0.15em] uppercase md:text-xs">
            <p>Contact</p>
            <p>Larissa, Greece</p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              className="w-fit max-w-full text-[clamp(1.4rem,4.6vw,5.5rem)] leading-[0.95] font-black tracking-[-0.03em] break-all uppercase hover:bg-black hover:text-background"
            >
