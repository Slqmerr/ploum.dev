  ...
  return (
    ...
    >
      ...
      <div id="page-content" className="flex min-h-svh flex-col">
        ...
        {/* Manifesto — black band; its artistic words link to /services and
            /about. Flips the difference-blend header white. */}
       

        {/* Scroll-velocity marquee divider */}
        <Marquee />

        {/* Bottom typography — pb gives it room to breathe before the curtain
            footer (triggered at #page-content's bottom) reveals. */}
        <section className="mt-14 flex flex-1 items-end justify-end pb-[28vh] md:pb-[36vh]">
          <h2 className="text-right text-[clamp(2.8rem,9.6vw,10.5rem)] leading-[0.85] font-black tracking-[-0.04em] uppercase select-none">
            <Reveal lines={["THANK", "YOU"]} />
          </h2>
        </section>
      </div>
